    ...
    public partial class MainWindowViewModel : ObservableObject
    {
        ...
        private ObservableCollection<object> _menuItems = new()
        {
            ...
            new NavigationViewItem()
            {
                ...
                TargetPageType = typeof(Views.Pages.PlayerPage)
            },
            new NavigationViewItem()
            {
                Content = "Friends",
                Icon = new SymbolIcon { Symbol = SymbolRegular.People20 },
                TargetPageType = typeof(Views.Pages.FriendPage)
            },
            new NavigationViewItem()
            {
                Content = "Groups",
                Icon = new SymbolIcon { Symbol = SymbolRegular.People20 },
                TargetPageType = typeof(Views.Pages.GroupPage)
            },
            new NavigationViewItem()
            {
                Content = "Games",
